...
const truncateStr = (fullString, stringLength) => {
...
export default function NFTBox({ price, nftAddress, tokenId, marketplaceAddress, seller }) {
    ...
    async function updateUI() {
        ...
        if (tokenURI) {
            ...
            // We could also render the image on our server
            // Or for testnets & mainnets use moralis server hooks
            // Or wait for everyone to adopt IPFS
        }
    }
